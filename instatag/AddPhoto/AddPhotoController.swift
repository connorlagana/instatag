...
class AddPhotoController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    @objc func handleNext() {
        let nextPhotoController = NextPhotoController()
        nextPhotoController.selectedImage = header?.photoImageView.image
        navigationController?.pushViewController(nextPhotoController, animated: true)
    }
